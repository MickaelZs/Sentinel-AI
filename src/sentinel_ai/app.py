...
from sentinel_ai.agents.investigation.service import InvestigationService
from sentinel_ai.api.routes.health import router as health_router
from sentinel_ai.api.routes.investigations import router as investigations_router
...
app.state.investigation_service = InvestigationService(app.state.inference_service)
